...
function RealtimePresenceCards() {
  ...
  const cards = [
    ...
    { label: 'Nas Notificações', count: notificationsCount, icon: Radio, color: 'yellow-500', borderClass: 'border-yellow-500/30 bg-yellow-500/5', desc: 'pessoas nas notificações agora' },
